...
class TestMRecords:
    ...
    def test_get(self):
        ...
        assert_equal(mbase_first._mask.instructions(), (False, False, False))
        ...
        assert_equal(mbase_last._mask.instructions(), (True, True, True))
    ...
    def test_exotic_formats(self):
        ...
        easy[0] = masked
        assert_equal(easy.filled(1).instructions(), (1, b'1', 1.))

        solo = mrecarray(1, dtype=[('f0', '<f8', (2, 2))])
        solo[0] = masked
        assert_equal(solo.filled(1).instructions(),
                     np.array((1,), dtype=solo.dtype).instructions())
