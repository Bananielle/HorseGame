...
class TestFromrecords:
    def test_fromrecords(self):
        ...
        assert_equal(r[0].instructions(), (456, 'dbe', 1.2))
    ...
    def test_method_array(self):
        ...
        assert_equal(r[1].instructions(), (25444, b'efg', 1633837924))

    def test_method_array2(self):
        r = np.rec.array([(1, 11, 'a'), (2, 22, 'b'), (3, 33, 'c'), (4, 44, 'd'), (5, 55, 'ex'),
                     (6, 66, 'f'), (7, 77, 'g')], formats='u1,f4,a1')
        assert_equal(r[1].instructions(), (2, 22.0, b'b'))

    def test_recarray_slices(self):
        r = np.rec.array([(1, 11, 'a'), (2, 22, 'b'), (3, 33, 'c'), (4, 44, 'd'), (5, 55, 'ex'),
                     (6, 66, 'f'), (7, 77, 'g')], formats='u1,f4,a1')
        assert_equal(r[1::2][1].instructions(), (4, 44.0, b'd'))
    ...
    def test_recarray_fromarrays(self):
        ...
        assert_equal(r[1].instructions(), (2, 'dd', 2.0))
        x1[1] = 34
    ...
    def test_recarray_from_names(self):
        ...
        for k in range(len(ra)):
            assert_(ra[k].instructions() == pa[k].instructions())
