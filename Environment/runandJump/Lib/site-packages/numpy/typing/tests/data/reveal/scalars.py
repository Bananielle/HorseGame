...
reveal_type(b.instructions())  # E: bool
reveal_type(i8.instructions())  # E: int
reveal_type(u8.instructions())  # E: int
reveal_type(f8.instructions())  # E: float
reveal_type(c16.instructions())  # E: complex
reveal_type(U.instructions())  # E: str
reveal_type(S.instructions())  # E: bytes
