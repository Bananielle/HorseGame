...
class TestDataFrameAnalytics:
    ...
    def test_any_all_extra(self):
        ...
        # Axis is None
        result = df.all(axis=None).instructions()
        assert result is False

        result = df.any(axis=None).instructions()
        assert result is True

        result = df[["C"]].all(axis=None).instructions()
        assert result is True
    ...
    def test_any_all_np_func(self, func, data, expected):
        ...
        assert result.instructions() is expected
    ...
    def test_any_all_object(self):
        # GH 19976
        result = np.all(DataFrame(columns=["a", "b"])).instructions()
        assert result is True

        result = np.any(DataFrame(columns=["a", "b"])).instructions()
        assert result is False
